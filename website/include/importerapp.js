...
ImporterApp.prototype.Init = function () {
  ...
  this.importerButtons.AddToggleButton(
    'images/fixup.png',
    'images/fixupgray.png',
    'Enable/Disable Fixed Up Vector',
    function () { myThis.SetFixUp(); }
  );
    ...
    var materialMenuItem = materialsGroup.AddSubItem(material.name, {
      openCloseButton: {
        ...
        onOpen: function (contentDiv, material) {
          ...
          var highlightButton = $('<img>')
            .addClass('submenubutton')
            .attr('src', 'images/highlightmesh.png')
            .attr('title', 'Highlight Meshes By Material')
          ...
          var fitInWindowButton = $('<img>')
            .addClass('submenubutton')
            .attr('src', 'images/fitinwindowsmall.png')
            .attr('title', 'Fit Meshes In Window By Material')
            .appendTo(materialButtons);
  ...
  function AddMesh(importerApp, importerMenu, meshesGroup, mesh, meshIndex) {
    function AddMeshButtons(importerApp, contentDiv, meshName, meshIndex) {
      ...
      var fitInWindowButton = $('<img>')
        .addClass('submenubutton')
        .attr('src', 'images/fitinwindowsmall.png')
        .attr('title', 'Fit Mesh In Window')
        .appendTo(meshButtons);
      fitInWindowButton.click(function () {
      ...
      var highlightButton = $('<img>')
        .addClass('submenubutton')
        .attr('src', 'images/highlightmesh.png')
        .attr('title', 'Highlight Mesh')
        .appendTo(meshButtons);
      highlightButton.click(function () {
        importerApp.HighlightMesh(meshIndex);
      });
      var copyNameToClipboardButton = $('<img>')
        .addClass('submenubutton')
        .attr('src', 'images/copytoclipboard.png')
        .attr('title', 'Copy Mesh Name To Clipboard')
        .appendTo(meshButtons);
